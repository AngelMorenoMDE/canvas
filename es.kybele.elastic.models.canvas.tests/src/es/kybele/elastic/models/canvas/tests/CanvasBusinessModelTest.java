 ...
 * @generated
 */
public class CanvasBusinessModelTest extends TestCase {
	 ...
	 * @generated
	 */
	protected CanvasBusinessModel fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(CanvasBusinessModelTest.class);
	}
	 ...
	 * @generated
	 */
	public CanvasBusinessModelTest(String name) {
		super(name);
	}
	 ...
	 * @generated
	 */
	protected void setFixture(CanvasBusinessModel fixture) {
	 ...
	 * @generated
	 */
	protected CanvasBusinessModel getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(CanvasFactory.eINSTANCE.createCanvasBusinessModel());
	}
