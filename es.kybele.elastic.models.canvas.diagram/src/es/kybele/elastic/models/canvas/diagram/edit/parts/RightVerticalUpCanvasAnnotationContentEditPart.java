 ...
 * @generated
 */
public class RightVerticalUpCanvasAnnotationContentEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RightVerticalUpCanvasAnnotationContentEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CanvasParserProvider.getParser(CanvasElementTypes.CanvasAnnotation_3005, getParserElement(),
					CanvasVisualIDRegistry.getType(
							es.kybele.elastic.models.canvas.diagram.edit.parts.RightVerticalUpCanvasAnnotationContentEditPart.VISUAL_ID));
		}
		return parser;
	}
