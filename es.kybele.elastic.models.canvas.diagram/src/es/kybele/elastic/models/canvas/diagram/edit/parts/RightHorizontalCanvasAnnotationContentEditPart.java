 ...
 * @generated
 */
public class RightHorizontalCanvasAnnotationContentEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RightHorizontalCanvasAnnotationContentEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CanvasParserProvider.getParser(CanvasElementTypes.CanvasAnnotation_3009, getParserElement(),
					CanvasVisualIDRegistry.getType(
							es.kybele.elastic.models.canvas.diagram.edit.parts.RightHorizontalCanvasAnnotationContentEditPart.VISUAL_ID));
		}
		return parser;
	}
