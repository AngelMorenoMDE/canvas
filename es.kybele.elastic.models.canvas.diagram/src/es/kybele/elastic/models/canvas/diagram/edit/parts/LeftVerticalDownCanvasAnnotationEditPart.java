...
import es.kybele.elastic.models.canvas.diagram.edit.policies.LeftVerticalDownCanvasAnnotationItemSemanticEditPolicy;
import es.kybele.elastic.models.canvas.diagram.part.CanvasVisualIDRegistry;

/**
 * @generated
 */
public class LeftVerticalDownCanvasAnnotationEditPart extends ShapeNodeEditPart {
	@Override
	 ...
	 * @generated
	 */
	public LeftVerticalDownCanvasAnnotationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LeftVerticalDownCanvasAnnotationItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LeftVerticalDownCanvasAnnotationContentEditPart) {
			((LeftVerticalDownCanvasAnnotationContentEditPart) childEditPart)
