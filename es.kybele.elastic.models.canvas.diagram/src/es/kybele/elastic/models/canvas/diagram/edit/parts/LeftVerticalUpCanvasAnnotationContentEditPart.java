 ...
 * @generated
 */
public class LeftVerticalUpCanvasAnnotationContentEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LeftVerticalUpCanvasAnnotationContentEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CanvasParserProvider.getParser(CanvasElementTypes.CanvasAnnotation_3002, getParserElement(),
					CanvasVisualIDRegistry.getType(
							es.kybele.elastic.models.canvas.diagram.edit.parts.LeftVerticalUpCanvasAnnotationContentEditPart.VISUAL_ID));
		}
		return parser;
	}
