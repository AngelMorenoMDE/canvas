...
import es.kybele.elastic.models.canvas.diagram.edit.policies.RightHorizontalCanvasAnnotationItemSemanticEditPolicy;
import es.kybele.elastic.models.canvas.diagram.part.CanvasVisualIDRegistry;

/**
 * @generated
 */
public class RightHorizontalCanvasAnnotationEditPart extends ShapeNodeEditPart {
	@Override
	 ...
	 * @generated
	 */
	public RightHorizontalCanvasAnnotationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RightHorizontalCanvasAnnotationItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RightHorizontalCanvasAnnotationContentEditPart) {
			((RightHorizontalCanvasAnnotationContentEditPart) childEditPart)
