...
import es.kybele.elastic.models.canvas.diagram.edit.policies.CanvasTextSelectionEditPolicy;
 ...
 * @generated
 */
public class LeftVerticalDownCanvasAnnotationContentEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LeftVerticalDownCanvasAnnotationContentEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new CanvasTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CanvasParserProvider.getParser(CanvasElementTypes.CanvasAnnotation_3003, getParserElement(),
					CanvasVisualIDRegistry.getType(
							es.kybele.elastic.models.canvas.diagram.edit.parts.LeftVerticalDownCanvasAnnotationContentEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, CanvasEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
