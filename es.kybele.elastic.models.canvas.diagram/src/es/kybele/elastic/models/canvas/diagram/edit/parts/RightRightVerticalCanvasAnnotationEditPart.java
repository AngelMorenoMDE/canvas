...
import es.kybele.elastic.models.canvas.diagram.edit.policies.RightRightVerticalCanvasAnnotationItemSemanticEditPolicy;
import es.kybele.elastic.models.canvas.diagram.part.CanvasVisualIDRegistry;

/**
 * @generated
 */
public class RightRightVerticalCanvasAnnotationEditPart extends ShapeNodeEditPart {
	@Override
	 ...
	 * @generated
	 */
	public RightRightVerticalCanvasAnnotationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RightRightVerticalCanvasAnnotationItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RightRightVerticalCanvasAnnotationContentEditPart) {
			((RightRightVerticalCanvasAnnotationContentEditPart) childEditPart)
