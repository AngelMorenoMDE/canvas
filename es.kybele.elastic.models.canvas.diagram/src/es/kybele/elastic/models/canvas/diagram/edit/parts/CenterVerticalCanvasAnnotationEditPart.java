...
import es.kybele.elastic.models.canvas.diagram.edit.policies.CanvasAnnotation4ItemSemanticEditPolicy;
import es.kybele.elastic.models.canvas.diagram.part.CanvasVisualIDRegistry;

/**
 * @generated
 */
public class CenterVerticalCanvasAnnotationEditPart extends ShapeNodeEditPart {
	@Override
	 ...
	 * @generated
	 */
	public CenterVerticalCanvasAnnotationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CanvasAnnotation4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CenterVerticalCanvasAnnotationContentEditPart) {
			((CenterVerticalCanvasAnnotationContentEditPart) childEditPart)
