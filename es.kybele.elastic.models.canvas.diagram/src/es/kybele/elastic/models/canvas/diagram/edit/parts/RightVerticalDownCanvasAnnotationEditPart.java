...
import es.kybele.elastic.models.canvas.diagram.edit.policies.RightVerticalDownCanvasAnnotationItemSemanticEditPolicy;
import es.kybele.elastic.models.canvas.diagram.part.CanvasVisualIDRegistry;

/**
 * @generated
 */
public class RightVerticalDownCanvasAnnotationEditPart extends ShapeNodeEditPart {
	@Override
	 ...
	 * @generated
	 */
	public RightVerticalDownCanvasAnnotationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RightVerticalDownCanvasAnnotationItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RightVerticalDownCanvasAnnotationContentEditPart) {
			((RightVerticalDownCanvasAnnotationContentEditPart) childEditPart)
