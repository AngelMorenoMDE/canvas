...
import es.kybele.elastic.models.canvas.diagram.edit.policies.RightVerticalUpCanvasAnnotationItemSemanticEditPolicy;
import es.kybele.elastic.models.canvas.diagram.part.CanvasVisualIDRegistry;

/**
 * @generated
 */
public class RightVerticalUpCanvasAnnotationEditPart extends ShapeNodeEditPart {
	@Override
	 ...
	 * @generated
	 */
	public RightVerticalUpCanvasAnnotationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RightVerticalUpCanvasAnnotationItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RightVerticalUpCanvasAnnotationContentEditPart) {
			((RightVerticalUpCanvasAnnotationContentEditPart) childEditPart)
