 ...
 * @generated
 */
public class LeftHorizontalCanvasAnnotationContentEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LeftHorizontalCanvasAnnotationContentEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CanvasParserProvider.getParser(CanvasElementTypes.CanvasAnnotation_3008, getParserElement(),
					CanvasVisualIDRegistry.getType(
							es.kybele.elastic.models.canvas.diagram.edit.parts.LeftHorizontalCanvasAnnotationContentEditPart.VISUAL_ID));
		}
		return parser;
	}
