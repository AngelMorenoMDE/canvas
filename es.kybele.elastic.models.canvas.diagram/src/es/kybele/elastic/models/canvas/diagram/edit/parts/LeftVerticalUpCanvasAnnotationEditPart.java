...
import es.kybele.elastic.models.canvas.diagram.edit.policies.CanvasAnnotation2ItemSemanticEditPolicy;
import es.kybele.elastic.models.canvas.diagram.part.CanvasVisualIDRegistry;

/**
 * @generated
 */
public class LeftVerticalUpCanvasAnnotationEditPart extends ShapeNodeEditPart {
	@Override
	 ...
	 * @generated
	 */
	public LeftVerticalUpCanvasAnnotationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CanvasAnnotation2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LeftVerticalUpCanvasAnnotationContentEditPart) {
			((LeftVerticalUpCanvasAnnotationContentEditPart) childEditPart)
