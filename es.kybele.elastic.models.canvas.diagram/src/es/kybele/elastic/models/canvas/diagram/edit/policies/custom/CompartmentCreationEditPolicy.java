...
package es.kybele.elastic.models.canvas.diagram.edit.policies.custom;
 ...
 * @author choang
 */
public class CompartmentCreationEditPolicy extends AbstractEditPolicy {
	...
	private Command getUnspecifiedTypeCreateCommand(
		...
		List elementTypesRequest = request.getElementTypes();
		
		for (Iterator iter = request.getElementTypes().iterator(); iter.hasNext();) 
		{
			...
			if (createRequest != null) 
			{
				...
				if ("es.kybele.elastic.models.canvas.diagram.CanvasAnnotation_3001".equals(elementType.getId()))
				{
					System.out.println("Es igual");
					return individualCmd;
				}
