 ...
 * @generated
 */
public class RightRightVerticalCanvasAnnotationContentEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RightRightVerticalCanvasAnnotationContentEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CanvasParserProvider.getParser(CanvasElementTypes.CanvasAnnotation_3007, getParserElement(),
					CanvasVisualIDRegistry.getType(
							es.kybele.elastic.models.canvas.diagram.edit.parts.RightRightVerticalCanvasAnnotationContentEditPart.VISUAL_ID));
		}
		return parser;
	}
