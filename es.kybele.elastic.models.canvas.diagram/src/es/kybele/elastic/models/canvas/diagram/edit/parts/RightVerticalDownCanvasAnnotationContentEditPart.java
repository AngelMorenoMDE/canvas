 ...
 * @generated
 */
public class RightVerticalDownCanvasAnnotationContentEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RightVerticalDownCanvasAnnotationContentEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CanvasParserProvider.getParser(CanvasElementTypes.CanvasAnnotation_3006, getParserElement(),
					CanvasVisualIDRegistry.getType(
							es.kybele.elastic.models.canvas.diagram.edit.parts.RightVerticalDownCanvasAnnotationContentEditPart.VISUAL_ID));
		}
		return parser;
	}
