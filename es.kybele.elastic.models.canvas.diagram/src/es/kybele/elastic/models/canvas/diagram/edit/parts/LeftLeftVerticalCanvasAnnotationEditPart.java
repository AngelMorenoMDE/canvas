...
import es.kybele.elastic.models.canvas.diagram.edit.policies.LeftLeftVerticalCanvasAnnotationItemSemanticEditPolicy;
import es.kybele.elastic.models.canvas.diagram.part.CanvasVisualIDRegistry;
import es.kybele.elastic.models.canvas.impl.CanvasAnnotationImpl;

/**
 * @generated
 */
public class LeftLeftVerticalCanvasAnnotationEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public LeftLeftVerticalCanvasAnnotationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LeftLeftVerticalCanvasAnnotationItemSemanticEditPolicy());
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CanvasVisualIDRegistry.getType(CanvasAnnotationContentEditPart.VISUAL_ID));
	}
