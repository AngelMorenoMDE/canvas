 ...
 * @generated
 */
public class CanvasDomainNavigatorContentProvider implements ICommonContentProvider {
	 ...
	 * @generated
	 */
	public CanvasDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof CanvasDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((CanvasDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new CanvasDomainNavigatorItem((EObject) objects[i], parentElement,
